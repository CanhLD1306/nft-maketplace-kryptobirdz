    ...
    <div className="flex justify-center">
      <div className="px-4" style={{maxWidth: '160px'}}>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
          {
            nfts.map((nft, i) => (
              <div key={i} className="border shadow rounded-x1 overflow-hideen">
                <img src={nft.image} />
                <div className="p-4">
                  ...
                  <div style={{height: '72px', overflow:'hidden'}}>
                    <p className="text-gray-400">{nfts.description}</p>
                  </div>
                </div>  
                <div className="p-4 bg-black">
                  <p className="text-3x-1 mb-4 font-bold text-white">{nfts.price} ETH</p>
